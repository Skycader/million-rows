...
const countActualRows = () =>
  document.querySelector("#container").children[0].children.length;
const renderActualRows = () =>
  (document.querySelector("#count").innerHTML = countActualRows());
setInterval(renderActualRows, 100);
